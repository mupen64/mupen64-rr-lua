...
void disasm(FILE *f, uint32_t t[0x1000 / 4])
{
    ...
    for (i = 0; i < (0x1000 / 4); i++)
    {
        ...
        case 7:
            ...
            break;
        case 8:
            fprintf(f, "ADDI r%d, r%d, %d\n", (t[i] >> 16) & 0x1F, (t[i] >> 21) & 0x1F, (int)((int16_t)(t[i] & 0xFFFF)));
            break;
        case 9:
        ...
        case 14:
            ...
            break;
        case 15:
            fprintf(f, "LUI r%d, %d\n", (t[i] >> 16) & 0x1F, (int)((int16_t)(t[i] & 0xFFFF)));
            break;
        case 16:
            switch ((t[i] >> 21) & 0x1F)
            {
        ...
        case 31:
            ...
            break;
        case 32:
            fprintf(f, "LB r%d, %d(r%d)\n", (t[i] >> 16) & 0x1F, (int)((int16_t)(t[i] & 0xFFFF)), (t[i] >> 21) & 0x1F);
            break;
        case 33:
