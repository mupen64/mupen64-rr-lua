...
class PluginSet final
{
  public:
     ...
     */
    PluginSet(mup_core_functions core_funcs, std::filesystem::path video_path, std::filesystem::path audio_path, std::filesystem::path input_path,
     ...
     */
    void initiate_all(core_ctx &ctx, core_params& params, const std::function<mup_wm_handle(const mupv_wm_settings &)>& create_window);
