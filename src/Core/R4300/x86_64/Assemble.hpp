...
void movss_xmm_preg64(int32_t xmm, int32_t reg64);
void movss_preg64_xmm(int32_t reg64, int32_t xmm);
...
void andps_xmm_xmm(int32_t dst, int32_t src);
void xorps_xmm_xmm(int32_t dst, int32_t src);
void ucomiss_xmm_xmm(int32_t a, int32_t b);
// SSE double-precision emitters (FP JIT port)
void movsd_xmm_preg64(int32_t xmm, int32_t reg64);
void movsd_preg64_xmm(int32_t reg64, int32_t xmm);
...
void cvtss2sd_xmm_preg64(int32_t xmm, int32_t reg64);
void cvtsd2ss_xmm_preg64(int32_t xmm, int32_t reg64);
void cvttss2si_reg32_preg64(int32_t dst, int32_t base);
void cvtss2si_reg32_preg64(int32_t dst, int32_t base);
void mov_preg64_reg32(int32_t base, int32_t src);
void cvttss2si_reg64_preg64(int32_t dst, int32_t base);
void cvtss2si_reg64_preg64(int32_t dst, int32_t base);
void mov_preg64_reg64(int32_t base, int32_t src);
void cvttsd2si_reg32_preg64(int32_t dst, int32_t base);
void cvtsd2si_reg32_preg64(int32_t dst, int32_t base);
void cvttsd2si_reg64_preg64(int32_t dst, int32_t base);
void cvtsd2si_reg64_preg64(int32_t dst, int32_t base);
void cvtsi2ss_xmm_preg64(int32_t xmm, int32_t base);
void cvtsi2ssq_xmm_preg64(int32_t xmm, int32_t base);
void cvtsi2sd_xmm_preg64(int32_t xmm, int32_t base);
