...
// DEBUG (temporary): interpret all COP1.D ops — same hardcoded-x86-jump-offset
// bug as GCop1S.cpp (jne_rj(12)/jmp_imm_short(10) vs 17-byte x64 _m32_imm32).
...
void genadd_d()
{
    ...
    fld_preg32_qword(EAX);
    mov_eax_memoffs32((void *)(&reg_cop1_double[dst->f.cf.ft]));
