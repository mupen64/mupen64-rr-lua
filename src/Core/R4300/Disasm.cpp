...
const INSTFTYPE InstFormatType[INSTF_COUNT] = {INSTFTYPE_NONE, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I,
    INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_I, INSTFTYPE_J, INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_R,
    INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_R, INSTFTYPE_LF, INSTFTYPE_LF, INSTFTYPE_CF,
    INSTFTYPE_CF, INSTFTYPE_CF};
...
const char *const COP0RegisterName[32] = {"index", "random", "entrylo0", "entrylo1", "context", "pagemask", "wired",
    "reserved07", "badvaddr", "count", "entryhi", "compare", "status", "cause", "epc", "previd", "config", "lladdr",
    "watchlo", "watchhi", "xcontext", "reserved21", "reserved22", "reserved23", "reserved24", "reserved25", "perr",
    "cacheerr", "taglo", "taghi", "errorepc", "reserved1f"};
