...
#pragma region Host-Provided
     ...
     */
    size_t (*show_multiple_choice_dialog)(const std::string& id, const std::vector<std::wstring>& choices, const wchar_t* str, const wchar_t* title, size_t default_index, core_dialog_type type);
