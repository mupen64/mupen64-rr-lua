...
const std::wstring LOAD_SCRIPT_DIRECT = APP + L"Scripts > # Load Script...";
const std::wstring SHOW_INSTANCES = APP + L"Scripts > Show Instances ---";
const std::wstring RECENT_SCRIPTS = APP + L"Scripts > Recent Scripts ---";
const std::wstring STOP_ALL = APP + L"Scripts > Stop All";
const std::wstring CLOSE_ALL = APP + L"Scripts > Close All";
