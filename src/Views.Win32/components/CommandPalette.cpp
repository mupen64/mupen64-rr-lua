...
struct t_listbox_item
{
    ...
    static t_listbox_item make_option(t_options_item *item, const t_options_group &group);
    static t_listbox_item make_option_group(const t_options_group &options_group);
...
t_listbox_item t_listbox_item::make_option(
    t_options_item *options_item, const t_options_group &group)
{
    t_listbox_item item{};
...
t_listbox_item t_listbox_item::make_option_group(const t_options_group &options_group)
{
    t_listbox_item item{};
...
static void add_options()
{
    ...
    {
        std::erase_if(group.items, [&](t_options_item &item) {
            return item.type == t_options_item::Type::Hotkey;
        });
