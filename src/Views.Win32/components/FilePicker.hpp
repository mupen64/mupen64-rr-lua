 ...
 */
std::filesystem::path show_open_dialog(const std::string &id, HWND hwnd, const std::string &filter);

/**
 * \brief Shows a file save dialog. Wraps \ref WinFilePicker::show_save_dialog.
 */
std::filesystem::path show_save_dialog(const std::string &id, HWND hwnd, const std::string &filter);

/**
 * \brief Shows a folder selection dialog. Wraps \ref WinFilePicker::show_folder_dialog.
 */
std::filesystem::path show_folder_dialog(const std::string &id, HWND hwnd);
} // namespace FilePicker
