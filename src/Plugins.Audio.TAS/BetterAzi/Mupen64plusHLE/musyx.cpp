...
static void update_base_vol(struct hle_t* hle, int32_t* base_vol, uint32_t voice_mask, uint32_t last_sample_ptr, uint8_t mask_15, uint32_t ptr_24);
...
static void load_samples_PCM16(struct hle_t* hle, uint32_t voice_ptr, int16_t* samples, unsigned* segbase, unsigned* offset);
static void load_samples_ADPCM(struct hle_t* hle, uint32_t voice_ptr, int16_t* samples, unsigned* segbase, unsigned* offset);
...
static void mix_voice_samples(struct hle_t* hle, musyx_t* musyx, uint32_t voice_ptr, const int16_t* samples, unsigned segbase, unsigned offset, uint32_t last_sample_ptr);
...
static void interleave_stage_v2(struct hle_t* hle, musyx_t* musyx, uint16_t mask_16, uint32_t ptr_18, uint32_t ptr_1c, uint32_t output_ptr);
...
static void sfx_stage(struct hle_t* hle, mix_sfx_with_main_subframes_t mix_sfx_with_main_subframes, musyx_t* musyx, uint32_t sfx_ptr, uint16_t idx)
{
    unsigned int i;
