 ...
 * \return The operation result
 */
CoreResult read_movie_inputs(std::filesystem::path path,
 ...
 * \return The operation result
 */
CoreResult start_record(std::filesystem::path path, uint16_t flags,
 ...
 * \return The operation result
 */
CoreResult replace_author_info(const std::filesystem::path &path,
 ...
 * result
 */
CoreResult convert_freeze_buffer_to_movie(const t_movie_freeze &freeze,
