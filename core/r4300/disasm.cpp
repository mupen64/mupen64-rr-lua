...
static INST MainInstruction[1 << 6] = {
    INST_UNDEF, INST_UNDEF,  INST_J,     INST_JAL,   INST_BEQ,   INST_BNE,
    INST_BLEZ,  INST_BGTZ,   INST_ADDI,  INST_ADDIU, INST_SLTI,  INST_SLTIU,
    INST_ANDI,  INST_ORI,    INST_XORI,  INST_LUI,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF,  INST_BEQL,  INST_BNEL,  INST_BLEZL, INST_BGTZL,
    INST_DADDI, INST_DADDIU, INST_LDL,   INST_LDR,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF,  INST_LB,    INST_LH,    INST_LWL,   INST_LW,
    INST_LBU,   INST_LHU,    INST_LWR,   INST_LWU,   INST_SB,    INST_SH,
    INST_SWL,   INST_SW,     INST_SDL,   INST_SDR,   INST_SWR,   INST_CACHE,
    INST_LL,    INST_LWC1,   INST_UNDEF, INST_UNDEF, INST_LLD,   INST_LDC1,
    INST_UNDEF, INST_LD,     INST_SC,    INST_SWC1,  INST_UNDEF, INST_UNDEF,
    INST_SCD,   INST_SDC1,   INST_UNDEF, INST_SD,
};
static INST SpecialInstruction[1 << 6] = {
    INST_SLL,     INST_UNDEF, INST_SRL,    INST_SRA,    INST_SLLV,  INST_UNDEF,
    INST_SRLV,    INST_SRAV,  INST_JR,     INST_JALR,   INST_UNDEF, INST_UNDEF,
    INST_SYSCALL, INST_BREAK, INST_UNDEF,  INST_SYNC,   INST_MFHI,  INST_MTHI,
    INST_MFLO,    INST_MTLO,  INST_DSLLV,  INST_UNDEF,  INST_DSRLV, INST_DSRAV,
    INST_MULT,    INST_MULTU, INST_DIV,    INST_DIVU,   INST_DMULT, INST_DMULTU,
    INST_DDIV,    INST_DDIVU, INST_ADD,    INST_ADDU,   INST_SUB,   INST_SUBU,
    INST_AND,     INST_OR,    INST_XOR,    INST_NOR,    INST_UNDEF, INST_UNDEF,
    INST_SLT,     INST_SLTU,  INST_DADD,   INST_DADDU,  INST_DSUB,  INST_DSUBU,
    INST_TGE,     INST_TGEU,  INST_TLT,    INST_TLTU,   INST_TEQ,   INST_UNDEF,
    INST_TNE,     INST_UNDEF, INST_DSLL,   INST_UNDEF,  INST_DSRL,  INST_DSRA,
    INST_DSLL32,  INST_UNDEF, INST_DSRL32, INST_DSRA32,
};
static INST RegimmInstruction[1 << 5] = {
    INST_BLTZ,  INST_BGEZ,   INST_BLTZL,  INST_BGEZL,   INST_UNDEF,
    INST_UNDEF, INST_UNDEF,  INST_UNDEF,  INST_TGEI,    INST_TGEIU,
    INST_TLTI,  INST_TLTIU,  INST_TEQI,   INST_UNDEF,   INST_TNEI,
    INST_UNDEF, INST_BLTZAL, INST_BGEZAL, INST_BLTZALL, INST_BGEZALL,
    INST_UNDEF, INST_UNDEF,  INST_UNDEF,  INST_UNDEF,   INST_UNDEF,
    INST_UNDEF, INST_UNDEF,  INST_UNDEF,  INST_UNDEF,   INST_UNDEF,
...
static INST Cop0Instruction[1 << 5] = {
    ...
    INST_MFC0,  INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_MTC0,  INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF,
...
static INST TlbInstruction[1 << 6] = {
    INST_UNDEF, INST_TLBR,  INST_TLBWI, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_TLBWR, INST_UNDEF, INST_TLBP,  INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_ERET,  INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
...
static INST Cop1Instruction[1 << 5] = {
    INST_MFC1,  INST_DMFC1, INST_CFC1,  INST_UNDEF, INST_MTC1,  INST_DMTC1,
    INST_CTC1,  INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF,
...
static INST SInstruction[1 << 6] = {
    ...
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_CVT_D_S,   INST_UNDEF,    INST_UNDEF,
    INST_CVT_W_S,   INST_CVT_L_S,   INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
...
static INST DInstruction[1 << 6] = {
    ...
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_CVT_S_D,   INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_CVT_W_D,   INST_CVT_L_D,   INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
    INST_UNDEF,     INST_UNDEF,     INST_UNDEF,    INST_UNDEF,
...
static INST WInstruction[1 << 6] = {
    ...
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_CVT_S_W, INST_CVT_D_W, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
...
static INST LInstruction[1 << 6] = {
    ...
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_CVT_S_L, INST_CVT_D_L, INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
    INST_UNDEF, INST_UNDEF, INST_UNDEF,   INST_UNDEF,   INST_UNDEF, INST_UNDEF,
...
const char *const OpecodeName[INST_COUNT] = {
    ...
    "lb",        "lbu",       "ld",        "ldl",       "ldr",      "lh",
    "lhu",       "ll",        "lld",       "lw",        "lwl",      "lwr",
    "lwu",       "sb",        "sc",        "scd",       "sd",       "sdl",
    "sdr",       "sh",        "sw",        "swl",       "swr",      "sync",

    "add",       "addi",      "addiu",     "addu",      "and",      "andi",
    "dadd",      "daddi",     "daddiu",    "daddu",     "ddiv",     "ddivu",
    "div",       "divu",      "dmult",     "dmultu",    "dsll",     "dsll32",
    "dsllv",     "dsra",      "dsra32",    "dsrav",     "dsrl",     "dsrl32",
    "dsrlv",     "dsub",      "dsubu",     "lui",       "mfhi",     "mflo",
    "mthi",      "mtlo",      "mult",      "multu",     "nor",      "or",
    "ori",       "sll",       "sllv",      "slt",       "slti",     "sltiu",
    "sltu",      "sra",       "srav",      "srl",       "srlv",     "sub",
    "subu",      "xor",       "xori",

    "beq",       "beql",      "bgez",      "bgezal",    "bgezall",  "bgezl",
    "bgtz",      "bgtzl",     "blez",      "blezl",     "bltz",     "bltzal",
    "bltzall",   "bltzl",     "bne",       "bnel",      "j",        "jal",
    "jalr",      "jr",
    ...
    "teq",       "teqi",      "tge",       "tgei",      "tgeiu",    "tgeu",
    "tlt",       "tlti",      "tltiu",     "tltu",      "tne",      "tnei",
    "cache",     "eret",      "mfc0",      "mtc0",      "tlbp",     "tlbr",
    "tlbwi",     "tlbwr",

    "mfc1",      "dmfc1",     "cfc1",      "mtc1",      "dmtc1",    "ctc1",
    "bc1f",      "bc1t",      "bc1fl",     "bc1tl",

    "add.s",     "sub.s",     "mul.s",     "div.s",     "sqrt.s",   "abs.s",
    "mov.s",     "neg.s",     "round.l.s", "trunc.l.s", "ceil.l.s", "floor.l.s",
    "round.w.s", "trunc.w.s", "ceil.w.s",  "floor.w.s", "cvt.d.s",  "cvt.w.s",
    "cvt.l.s",

    "c.f.s",     "c.un.s",    "c.eq.s",    "c.ueq.s",   "c.olt.s",  "c.ult.s",
    "c.ole.s",   "c.ule.s",   "c.sf.s",    "c.ngle.s",  "c.seq.s",  "c.ngl.s",
    "c.lt.s",    "c.nge.s",   "c.le.s",    "c.ngt.s",

    "add.d",     "sub.d",     "mul.d",     "div.d",     "sqrt.d",   "abs.d",
    "mov.d",     "neg.d",     "round.l.d", "trunc.l.d", "ceil.l.d", "floor.l.d",
    "round.w.d", "trunc.w.d", "ceil.w.d",  "floor.w.d", "cvt.s.d",  "cvt.w.d",
    "cvt.l.d",

    "c.f.d",     "c.un.d",    "c.eq.d",    "c.ueq.d",   "c.olt.d",  "c.ult.d",
    "c.ole.d",   "c.ule.d",   "c.sf.d",    "c.ngle.d",  "c.seq.d",  "c.ngl.d",
...
const INSTFTYPE InstFormatType[INSTF_COUNT] = {
    INSTFTYPE_NONE, INSTFTYPE_I,  INSTFTYPE_I,  INSTFTYPE_I, INSTFTYPE_I,
    INSTFTYPE_I,    INSTFTYPE_I,  INSTFTYPE_I,  INSTFTYPE_I, INSTFTYPE_I,
    INSTFTYPE_J,    INSTFTYPE_R,  INSTFTYPE_R,  INSTFTYPE_R, INSTFTYPE_R,
    INSTFTYPE_R,    INSTFTYPE_R,  INSTFTYPE_R,  INSTFTYPE_R, INSTFTYPE_LF,
    INSTFTYPE_LF,   INSTFTYPE_CF, INSTFTYPE_CF, INSTFTYPE_CF};
...
const char *const COP0RegisterName[32] = {
    ...
    "pagemask",   "wired",      "reserved07", "badvaddr",   "count",
    "entryhi",    "compare",    "status",     "cause",      "epc",
    "previd",     "config",     "lladdr",     "watchlo",    "watchhi",
...
#define BRANCH                                                                 \
  (pc + 4 + ((r4300wordsigned)(r4300halfsigned)o->i.immediate << 2))
