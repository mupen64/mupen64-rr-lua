...
private:
  // 44100=1s sample, soundbuffer capable of holding 4s future data in circular
  // buffer
  ...
  bool write_sound(uint8_t *buf, int len, int min_write_size,
                   int max_write_size, BOOL force, uint8_t bitrate);
