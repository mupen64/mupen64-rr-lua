...
namespace Cheats
{
    ...
    update_selection:
        {
            ...
            CheckDlgButton(hwnd, IDC_CHECK_CHEAT_ENABLED, Gameshark::scripts[selected_index]->resumed() ? BST_CHECKED : BST_UNCHECKED);
    ...
    void show() { DialogBox(g_app_instance, MAKEINTRESOURCE(IDD_CHEATS), g_main_hwnd, (DLGPROC)WndProc); }
} // namespace Cheats
