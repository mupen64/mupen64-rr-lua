...
"""Recursively format all .cpp/.hpp files in the project with clang-format.

Files ignored by .gitignore (and .clang-format-ignore) are skipped. Formatting
runs in parallel across multiple worker threads.
"""
