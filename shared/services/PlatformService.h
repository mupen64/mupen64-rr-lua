...
namespace PlatformService
{
     ...
     * \param module The handle to a platform-specific module type to get the
     * function from. \param name The function's name. \return The function pointer,
     * or nullptr.
     */
     ...
     * \param module The handle to a platform-specific module type to get the
     * function from. \return The free function in the module.
     */
