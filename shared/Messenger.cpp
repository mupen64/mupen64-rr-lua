...
// UID accumulator for generating unique subscriber IDs. Only write operation is
// increment.
size_t g_uid_accumulator;

// Whether a message is currently being broadcasted. Used to wait when
// subscribing.
std::atomic g_broadcasting = 0;

// Whether a subscription is currently happening. Used to wait when
// broadcasting.
