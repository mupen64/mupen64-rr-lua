...
#if (FMT_CPLUSPLUS >= 202002L || (FMT_CPLUSPLUS >= 201709L && FMT_GCC_VERSION >= 1002)) && ((!defined(_GLIBCXX_RELEASE) || _GLIBCXX_RELEASE >= 10) && (!defined(_LIBCPP_VERSION) || _LIBCPP_VERSION >= 10000) && (!FMT_MSC_VERSION || FMT_MSC_VERSION >= 1928)) && defined(__cpp_lib_is_constant_evaluated)
...
#if ((FMT_GCC_VERSION >= 1000 || FMT_CLANG_VERSION >= 1101) && (!defined(__apple_build_version__) || __apple_build_version__ >= 14000029L) && FMT_CPLUSPLUS >= 202002L) || (defined(__cpp_consteval) && (!FMT_MSC_VERSION || FMT_MSC_VERSION >= 1929))
...
public:
    ...
    FMT_CONSTEXPR_CHAR_TRAITS auto starts_with(basic_string_view<Char> sv) const noexcept -> bool { return size_ >= sv.size_ && std::char_traits<Char>::compare(data_, sv.data_, sv.size_) == 0; }
    FMT_CONSTEXPR_CHAR_TRAITS auto starts_with(Char c) const noexcept -> bool { return size_ >= 1 && std::char_traits<Char>::eq(*data_, c); }
    FMT_CONSTEXPR_CHAR_TRAITS auto starts_with(const Char* s) const -> bool { return starts_with(basic_string_view<Char>(s)); }
...
#define FMT_TYPE_CONSTANT(Type, constant)                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    ...
    // Bitsets of types.
    enum { sint_set = set(type::int_type) | set(type::long_long_type) | set(type::int128_type), uint_set = set(type::uint_type) | set(type::ulong_long_type) | set(type::uint128_type), bool_set = set(type::bool_type), char_set = set(type::char_type), float_set = set(type::float_type) | set(type::double_type) | set(type::long_double_type), string_set = set(type::string_type), cstring_set = set(type::cstring_type), pointer_set = set(type::pointer_type) };
