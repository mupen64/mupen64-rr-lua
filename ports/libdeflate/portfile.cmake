vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES remove_wrong_c_flags_modification.diff
)
...
# Zig 0.16 requires the complete feature set while compiling libdeflate's
# runtime-dispatched AVX-512 implementations. These paths remain selected only
# after libdeflate's runtime CPU feature check.
set(zig_avx512_flags "-mavx512f -mavx512bw -mavx512vl -mavx512vnni -mavx512vbmi -mvpclmulqdq")
vcpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        "-DCMAKE_C_FLAGS=${zig_avx512_flags}"
