...
retest.describe('mupen64', function()
    ...
    retest.describe('memory', function()
        ...
        retest.describe('read_and_write_raw_buffer', function()
            retest.it('writes_and_reads_string_buffer', function()
            ...
            retest.it('handles_binary_data', function()
