...
retest.describe('mupen64', function()
    ...
    retest.describe('memory', function()
        ...
        local last_rdram_addr = rdram_size - 1
        local wrapped_addr = rdram_size
        local wrapped_alias_addr = 0
        local last_oob_word_addr = rdram_size - 3
        ...
        retest.describe('readbyte', function()
            ...
            retest.it('wraps_address_past_rdram_end', function()
                memory.writebyte(wrapped_alias_addr, 0xA5)
        ...
        retest.describe('readbytesigned', function()
            ...
            retest.it('wraps_address_past_rdram_end', function()
                memory.writebyte(wrapped_alias_addr, 0xFF)
        ...
        retest.describe('readword', function()
            ...
            retest.it('wraps_address_past_rdram_end', function()
                memory.writeword(wrapped_alias_addr, 0x4321)
        ...
        retest.describe('readwordsigned', function()
            ...
            retest.it('wraps_address_past_rdram_end', function()
                memory.writeword(wrapped_alias_addr, 0xFFFF)
        ...
        retest.describe('readdword', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readdword(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                memory.writedword(wrapped_alias_addr, 0x89ABCDEF)
        ...
        retest.describe('readdwordsigned', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readdwordsigned(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                memory.writedword(wrapped_alias_addr, 0xFFFFFFFF)
        ...
        retest.describe('readqword', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readqword(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                memory.writeqword(wrapped_alias_addr, { 0x01234567, 0x89ABCDEF })
        ...
        retest.describe('readqwordsigned', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readqwordsigned(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                memory.writeqword(wrapped_alias_addr, { 0xFFFFFFFF, 0xFFFFFFFF })
        ...
        retest.describe('readfloat', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readfloat(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                local test_float = 42.25
                memory.writefloat(wrapped_alias_addr, test_float)
        ...
        retest.describe('readdouble', function()
            ...
            retest.it('errors_when_read_crosses_rdram_end', function()
                local func = function()
                    memory.readdouble(last_rdram_addr)
                end
                retest.expect(func).to.fail()
            end)
            retest.it('wraps_address_past_rdram_end', function()
                local test_double = -9876.54321
                memory.writedouble(wrapped_alias_addr, test_double)
        ...
        retest.describe('readsize', function()
            ...
            retest.it('wraps_1_byte_unsigned_address_past_rdram_end', function()
                memory.writebyte(wrapped_alias_addr, 0x42)
            ...
            retest.it('wraps_2_byte_unsigned_address_past_rdram_end', function()
                memory.writeword(wrapped_alias_addr, 0x1234)
            ...
            retest.it('wraps_4_byte_unsigned_address_past_rdram_end', function()
                memory.writedword(wrapped_alias_addr, 0x12345678)
            ...
            retest.it('wraps_8_byte_unsigned_address_past_rdram_end', function()
                memory.writeqword(wrapped_alias_addr, { 0x12345678, 0x9ABCDEF0 })
            ...
            retest.it('errors_when_4_byte_unsigned_read_crosses_rdram_end', function()
                local func = function()
                    memory.readsize(last_rdram_addr, 4)
                end
                retest.expect(func).to.fail()
            end)
            ...
            retest.it('errors_when_8_byte_unsigned_read_crosses_rdram_end', function()
                local func = function()
                    memory.readsize(last_rdram_addr, 8)
                end
                retest.expect(func).to.fail()
            end)
        ...
        retest.describe('writebyte', function()
            ...
            retest.it('wraps_address_past_rdram_end', function()
                ...
                retest.expect(memory.readbyte(wrapped_alias_addr)).to.equal(0xA5)
            end)
        end)
        ...
        retest.describe('writedword', function()
            ...
            retest.it('errors_when_write_crosses_rdram_end', function()
                local func = function()
                    memory.writedword(last_rdram_addr, 0x89ABCDEF)
                end
                retest.expect(func).to.fail()
            end)
        end)
        ...
        retest.describe('writeqword', function()
            ...
            retest.it('errors_when_write_crosses_rdram_end', function()
                local func = function()
                    memory.writeqword(last_rdram_addr, { 0x01234567, 0x89ABCDEF })
                end
                retest.expect(func).to.fail()
            end)
        end)
        ...
        retest.describe('writefloat', function()
            ...
            retest.it('errors_when_write_crosses_rdram_end', function()
                local func = function()
                    memory.writefloat(last_rdram_addr, 42.25)
                end
                retest.expect(func).to.fail()
            end)
        end)
        ...
        retest.describe('writedouble', function()
            ...
            retest.it('errors_when_write_crosses_rdram_end', function()
                local func = function()
                    memory.writedouble(last_rdram_addr, -9876.54321)
                end
                retest.expect(func).to.fail()
            end)
        end)
        ...
        retest.describe('writesize', function()
            ...
            retest.it('wraps_1_byte_unsigned_address_past_rdram_end', function()
                ...
                local value = memory.readbyte(wrapped_alias_addr)
                retest.expect(value).to.equal(0x42)
            end)
            retest.it('wraps_1_byte_signed_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, -1, -1)
                local value = memory.readbytesigned(wrapped_alias_addr)
                retest.expect(value).to.equal(-1)
            end)
            retest.it('wraps_2_byte_unsigned_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, 2, 0x1234)
                local value = memory.readword(wrapped_alias_addr)
                retest.expect(value).to.equal(0x1234)
            end)
            retest.it('wraps_2_byte_signed_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, -2, -1)
                local value = memory.readwordsigned(wrapped_alias_addr)
                retest.expect(value).to.equal(-1)
            end)
            retest.it('wraps_4_byte_unsigned_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, 4, 0x12345678)
                local value = memory.readdword(wrapped_alias_addr)
                retest.expect(value).to.equal(0x12345678)
            end)
            retest.it('wraps_4_byte_signed_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, -4, -1)
                local value = memory.readdwordsigned(wrapped_alias_addr)
                retest.expect(value).to.equal(-1)
            end)
            retest.it('wraps_8_byte_unsigned_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, 8, { 0x12345678, 0x9ABCDEF0 })
                local value = memory.readqword(wrapped_alias_addr)
                retest.expect(value[1]).to.equal(0x12345678)
                retest.expect(value[2]).to.equal(0x9ABCDEF0)
            end)
            retest.it('wraps_8_byte_signed_address_past_rdram_end', function()
                memory.writesize(wrapped_addr, -8, { 0xFFFFFFFF, 0xFFFFFFFF })
                local value = memory.readqwordsigned(wrapped_alias_addr)
                retest.expect(value[1]).to.equal(0xFFFFFFFF)
                retest.expect(value[2]).to.equal(0xFFFFFFFF)
            end)
        ...
        retest.describe('write', function()
            retest.it('writes_raw_buffer', function()
            ...
            retest.it('writes_binary_data', function()
                local binary = "\x00\x01\x02\x03\x04\x05"
                memory.write(test_addr, binary)
                local value = memory.read(test_addr, string.len(binary))
                retest.expect(value).to.equal(binary)
            end)
            retest.it('writes_empty_string', function()
                memory.write(test_addr, "")
                local value = memory.read(test_addr, 0)
                retest.expect(value).to.equal("")
            end)
            retest.it('writes_long_buffer', function()
                local long_string = string.rep("A", 256)
                memory.write(test_addr, long_string)
                local value = memory.read(test_addr, string.len(long_string))
                retest.expect(value).to.equal(long_string)
            end)
            retest.it('wraps_address_past_rdram_end', function()
                local test_string = "abc123"
                memory.write(wrapped_addr, test_string)
                local value = memory.read(wrapped_alias_addr, string.len(test_string))
                retest.expect(value).to.equal(test_string)
            end)
            retest.it('errors_when_buffer_crosses_rdram_end', function()
                local func = function()
                    memory.write(last_rdram_addr, "ab")
                end
                retest.expect(func).to.fail()
            end)
        end)
        ...
        retest.describe('read', function()
            retest.it('reads_raw_buffer', function()
