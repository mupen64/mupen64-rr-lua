...
#define DEF_GETTER(x, y)                                   \
    template <>                                            \
    inline uint32_t get_##x<ROT_90>(const Kernel_3x3& ker) \
    {                                                      \
        return ker.y;                                      \
    }
    DEF_GETTER(a, g)
...
#define DEF_GETTER(x, y)                                    \
    template <>                                             \
    inline uint32_t get_##x<ROT_180>(const Kernel_3x3& ker) \
    {                                                       \
        return ker.y;                                       \
    }
    DEF_GETTER(a, i)
...
#define DEF_GETTER(x, y)                                    \
    template <>                                             \
    inline uint32_t get_##x<ROT_270>(const Kernel_3x3& ker) \
    {                                                       \
        return ker.y;                                       \
    }
    DEF_GETTER(a, c)
